...
public class PayslipData {
    ...
    public PayslipData(String pid, String empId, String pay_date, int salaryPM, int full, int half, int sick, int dfull, int dhalf, int dsick, int totalDeduction, int totalSalary, String name) {
        this.pid = pid;
        this.empId = empId;
